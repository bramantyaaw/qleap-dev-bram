...
class LeftNav extends Component {
  render() {
    return (
      <div className="navigation scroll-bar" style={{ zIndex: "9999" }}>
          ...
          <div className="nav-content">
            <div className="nav-wrap bg-white bg-transparent-card rounded-xxl shadow-xss pt-3 pb-1 mb-2 mt-2">
              ...
              <ul className="mb-1 top-content">
                ...
                <li>
                  <Link to="/ezone" className="nav-content-bttn open-font">
                    <i className="feather-tv btn-round-md bg-blue-gradiant me-3 d-flex align-items-center justify-content-center"></i>
                    <span>Newsfeed</span>
                  </Link>
                </li>
                <li>
