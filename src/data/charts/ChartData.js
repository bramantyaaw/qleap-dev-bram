export const CoreCompetencySeries = [
  {
    data: [3, 2, 4, 4, 1, 4, 4, 4, 1],
  },
];
export const CoreCompetencyOption = {
  chart: {
    type: "bar",
    height: 350,
  },
...
export const BudgetExpenseChartOptions = {
  dataLabels: {
    enabled: true,
    background: { enabled: true, borderRadius: 2, backgroundColor: "#d42c26" },
    style: {
      fontSize: "12px",
      fontWeight: "bold",
      colors: ["#2642CA"],
 ...
 *   added in v1.2.0 for /dashboard/projects/single/task page
 */
export const TicketingTaskStatusChartSeries = [50, 20, 20, 10];
export const TicketingTaskStatusChartOptions = {
  dataLabels: {
    enabled: false,
  },
  labels: ["Open", "Revision", "Process", "Solved"],
  colors: ["#51A0C2", "#AE302E", "#FFAA46", "#19CB98"],
  chart: {
    width: 400,
    type: "donut",
  },
...
export const TaskStatusChartSeries = [60, 10, 10, 20];
export const TaskStatusChartOptions = {
  dataLabels: {
    enabled: false,
  },
  labels: ["Probation", "Re-contract", "Mutasi", "Promotion"],
  colors: ["#162674", "#FFAA46", "#E53F3C", "#19CB98"],
  chart: {
    width: 400,
    type: "donut",
  },
...
export const ChartData = [
  ...
  CoreCompetencyOption,
  CoreCompetencySeries,
];
