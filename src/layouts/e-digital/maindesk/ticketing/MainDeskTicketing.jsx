...
import PICTicketing from "../../../database-admin/ticket/PICTicketing";
import { Overview } from "../epcn/Overview";

const MainDeskTicketing = () => {
  let isDatabase = true;
  return (
    <EdigitalLayout>
      <Fragment>
            ...
            <Tab.Container defaultActiveKey="overview">
              ...
              <Tab.Content>
                <Tab.Pane eventKey="overview" className="pb-4 ps-2 p-4">
                  <Overview isDatabase={isDatabase} />
                </Tab.Pane>
                <Tab.Pane eventKey="transaction" className="pb-4 ps-2 p-4">
                  <PICTicketing isDatabase={isDatabase} />
                </Tab.Pane>
              </Tab.Content>
            </Tab.Container>
          </Col>
...
export default MainDeskTicketing;
