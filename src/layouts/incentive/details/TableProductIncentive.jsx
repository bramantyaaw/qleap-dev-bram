...
const TableProductIn = ({ arrData }) => {
  ...
  const columns = useMemo(
    () => [
      ...
      { accessor: "Posting_Date", Header: "Posting Date" },
      { accessor: "Quantity", Header: "Quantity" },
      { accessor: "Incentive_Product", Header: "Incentive Product" },
      { accessor: "Sales_Amount", Header: "Sales Amount" },
      { accessor: "Total_Incentive", Header: "Total Incentive" },
      { accessor: "POS_Number", Header: "POS Number" },
